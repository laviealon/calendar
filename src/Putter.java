public class Putter {
    ...
    /**
     * Puts an hour of a task into a day's .todaySchedule attribute (see README for why the word "put" is used here).
     ...
     */
    public void putHalfHourTask(Day day, Double startHour, String taskName){
        day.todaySchedule.put(startHour, taskName);
    }

    // TODO: REQUIRED FOR WALKTHROUGH.
    public void putProject(String projectName, Week week, NonFixedTask[] tasks){}
}
